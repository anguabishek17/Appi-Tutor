            ...
            <?php if (!$isFirebaseConfigured): ?>
                <div class="mb-6 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-sm">
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            <span class="font-semibold">Firebase Configuration Notice:</span> Please set valid Firebase client credentials in <code class="bg-amber-100 px-1 py-0.5 rounded">.env</code> to connect live authentication.
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="relative flex flex-col items-center p-3 border-2 border-indigo-600 bg-indigo-50/50 rounded-xl cursor-pointer role-option" id="roleParentCard">
                            ...
                            <span class="text-sm font-bold text-indigo-900">Student / Parent</span>
                            <span class="text-xs text-indigo-600 mt-0.5">Book tutors</span>
                        </label>
